...
full_model <- glm(class ~ ., data = biomarker_sstar, family = binomial)
reduced_model <- glm(class ~ DERM + IgD + PTN + RELT + CSK, data = biomarker_sstar, family = binomial)
